...
folder_path = "/data1/pzy/MUTANTS/LEMON"
folder_path1 = "/data1/zmx/Lemon"
...
path_list = []
itera = 0
ground = pd.read_excel("output_coverage_2.xlsx")
ground = list(ground["path"])
exist_models = []
for model in ground:
    exist_models.append(model.split("/")[-1])
print("exist_models", exist_models)
# exit(9999)
