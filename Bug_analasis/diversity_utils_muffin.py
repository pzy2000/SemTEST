...
class CoverageCalculator:
    ...
    def load_model(self, model_dir):
        ...
        for layer_info in self.model_structure.values():
            if 'input' not in layer_info['type']:
                if layer_info["type"] not in self.output_shapes:
...
if __name__ == '__main__':
    ...
    for model_id in os.listdir(output_dir):
        ...
        model_path = os.path.join(output_dir, model_id, 'models', 'model.json')
